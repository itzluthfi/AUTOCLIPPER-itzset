...
def run_process_video(video_id: int, youtube_url: str, user_id: int,
    ...
    return asyncio.run(_process_video_async(video_id, youtube_url, user_id, mode, tracking, video_template, sub_style, sub_anim, num_clips, sub_lang))
...
def process_video(video_id: int, youtube_url: str, user_id: int,
    ...
    return run_process_video(video_id, youtube_url, user_id, mode, tracking, video_template, sub_style, sub_anim, num_clips, sub_lang)
