...
class OutputSettingsSubPage(BaseSettingsSubPage):
    ...
    def create_content(self):
        ...
        # Split-Screen option
        splitscreen_frame = ctk.CTkFrame(tracking_frame, fg_color=("gray85", "gray20"), corner_radius=8)
        splitscreen_frame.pack(fill="x", pady=(10, 0))
        
        splitscreen_radio = ctk.CTkRadioButton(splitscreen_frame, text="Split-Screen (Host + Guest)", 
            variable=self.face_tracking_var, value="split_screen", 
            font=ctk.CTkFont(size=13, weight="bold"))
        splitscreen_radio.pack(anchor="w", padx=15, pady=(10, 5))
        
        ctk.CTkLabel(splitscreen_frame, text="• Stack left & right half of video vertically", 
            font=ctk.CTkFont(size=11), text_color="gray").pack(anchor="w", padx=35)
        ctk.CTkLabel(splitscreen_frame, text="• Great for two-person podcasts / interviews", 
            font=ctk.CTkFont(size=11), text_color="gray").pack(anchor="w", padx=35)
        ctk.CTkLabel(splitscreen_frame, text="• Instantly displays both speakers", 
            font=ctk.CTkFont(size=11), text_color="gray").pack(anchor="w", padx=35, pady=(0, 10))
